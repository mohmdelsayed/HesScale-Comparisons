#!/bin/bash
#SBATCH --array=1-30
#SBATCH --job-name="GGN_MNISTLOGREG"                       # single job name for the array
...
FILE="$SCRATCH/HesScale-Comparisons/experiments/grid_search_command_scripts/jobs_DiagGGNConstantDampingOptimizer_grid_search_mnist_logreg.txt"
