#!/bin/bash
#SBATCH --array=1-30
#SBATCH --job-name="GGNMC_LocalTestProblem"                       # single job name for the array
...
FILE="$SCRATCH/HesScale-Comparisons/experiments/grid_search_command_scripts/jobs_DiagGGNMCConstantDampingOptimizer_grid_search_localtestproblem.txt"
