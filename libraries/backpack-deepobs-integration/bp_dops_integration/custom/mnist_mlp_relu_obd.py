...
class mnist_mlp_relu_obd(UnregularizedTestproblem):
    def __init__(self, batch_size, weight_decay=None):
        ...
        """
        super(mnist_mlp_relu_obd, self).__init__(batch_size, weight_decay)
    ...
    def set_up(self):
        ...
        self.net = net_mlp_obd(num_outputs=10, use_tanh=False)
