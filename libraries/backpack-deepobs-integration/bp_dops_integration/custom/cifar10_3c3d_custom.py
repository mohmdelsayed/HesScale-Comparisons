...
class cifar10_3c3d_custom(TestProblem):
  ...
  """
    ...
    def __init__(self, batch_size, weight_decay=0.002):
        ...
        super(cifar10_3c3d_custom, self).__init__(batch_size, weight_decay)

    def set_up(self):
        """Set up the vanilla CNN test problem on Cifar-10."""
        self.data = cifar10(self._batch_size)
        self.loss_function = nn.CrossEntropyLoss
        self.net = net_cifar10_3c3d(num_outputs=10, use_tanh=True)
