...
from testproblems_modules import net_imagenet_allcnnc

class imagenet_allcnnc_relu(TestProblem):
  ...
  """
    ...
    def __init__(self, batch_size, weight_decay=0.0005):
        ...
        super(imagenet_allcnnc_relu, self).__init__(batch_size, weight_decay)

    def set_up(self):
        """Set up the All CNN C test problem on Cifar-100."""
        self.data = ImageNet(self._batch_size)
        self.loss_function = nn.CrossEntropyLoss
        self.net = net_imagenet_allcnnc(use_tanh=False)
