...
class cifar100_3c3d_relu(TestProblem):
  ...
  """
    def __init__(self, batch_size, weight_decay=0.002):
        super(cifar100_3c3d_relu, self).__init__(batch_size, weight_decay)

    def set_up(self):
        """Set up the vanilla CNN test problem on Cifar-100."""
        self.data = cifar100(self._batch_size)
        self.loss_function = nn.CrossEntropyLoss
        self.net = net_cifar10_3c3d(num_outputs=100, use_tanh=False)
